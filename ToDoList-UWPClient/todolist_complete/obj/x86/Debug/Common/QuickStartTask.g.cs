#pragma checksum "C:\Users\apchin\Documents\AzureMobileApps\ToDoList-UWPClient\todolist_complete\Common\QuickStartTask.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "D928DB573033FB92A5AF4CA0BE7201BA"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace todolist_complete
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        {
            private global::todolist_complete.QuickStartTask dataRoot;
            ...
            public void SetDataRoot(global::todolist_complete.QuickStartTask newDataRoot)
            {
                this.bindingsTracking.ReleaseAllListeners();
            ...
            private void Update_(global::todolist_complete.QuickStartTask obj, int phase)
            {
            ...
            private class QuickStartTask_obj1_BindingsTracking
            {
                ...
                public void DependencyPropertyChanged_Title(global::Windows.UI.Xaml.DependencyObject sender, global::Windows.UI.Xaml.DependencyProperty prop)
                {
                    ...
                    {
                        global::todolist_complete.QuickStartTask obj = sender as global::todolist_complete.QuickStartTask;
        if (obj != null)
        {
        ...
        if (obj != null)
        {
            bindings.Update_Number(obj.Number, DATA_CHANGED);
                ...
                public void UpdateChildListeners_(global::todolist_complete.QuickStartTask obj)
                {
                    QuickStartTask_obj1_Bindings bindings;
                    if(WeakRefToBindingObj.TryGetTarget(out bindings))
                    {
                        ...
                        {
                            bindings.dataRoot.UnregisterPropertyChangedCallback(global::todolist_complete.QuickStartTask.TitleProperty, tokenDPC_Title);
                            bindings.dataRoot.UnregisterPropertyChangedCallback(global::todolist_complete.QuickStartTask.DescriptionProperty, tokenDPC_Description);
                            bindings.dataRoot.UnregisterPropertyChangedCallback(global::todolist_complete.QuickStartTask.NumberProperty, tokenDPC_Number);
                        }
                        if (obj != null)
                        {
                            bindings.dataRoot = obj;
                            tokenDPC_Title = obj.RegisterPropertyChangedCallback(global::todolist_complete.QuickStartTask.TitleProperty, DependencyPropertyChanged_Title);
                            tokenDPC_Description = obj.RegisterPropertyChangedCallback(global::todolist_complete.QuickStartTask.DescriptionProperty, DependencyPropertyChanged_Description);
                            tokenDPC_Number = obj.RegisterPropertyChangedCallback(global::todolist_complete.QuickStartTask.NumberProperty, DependencyPropertyChanged_Number);
                        }
                    }
                }
            }
